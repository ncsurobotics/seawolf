...
{ 
  ...
  if(statusBitOne == 1){
    if(statusBitTwo == 0){
      blinkStatusGreen = lightOff;
    }
    else if(statusBitTwo == 1){
...
void setLights()
{
  ...
  if(blinkStatusGreen == lightOff){
    digitalWrite(green, LOW);
  }
  else if(greenCounter < blink/2){
