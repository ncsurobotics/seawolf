        ...
        for Box in self.Boxes[:]:
            if math.fabs(target.center[0] - Box.center[0]) < self.center_thresh and \
               math.fabs(target.center[1] - Box.center[1]) < self.center_thresh:
                if line_distance(Box.corner1, Box.corner2) + line_distance(Box.corner1, Box.corner3) < \
                   line_distance(target.corner1, target.corner2) + line_distance(target.corner1, target.corner3):
